  ...
  return (
    ...
    >
      <div className="flex min-h-screen w-full md:h-[100dvh] md:max-h-[100dvh] md:overflow-hidden">
        ...
        <div className="flex flex-col flex-1 min-w-0 min-h-screen md:min-h-0 md:h-full md:overflow-y-auto overflow-x-hidden">
          {header}
          <main className="relative flex-1 min-h-0 p-4 md:p-6 pb-20 md:pb-6">{children}</main>
        </div>
      </div>
      <MobileNav />
